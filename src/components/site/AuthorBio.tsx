  ...
  return (
    ...
    >
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start">
        <div
          aria-hidden="true"
          className="flex h-16 w-16 flex-none items-center justify-center rounded-full bg-accent/15 font-display text-xl font-bold text-gold-deep"
        >
          AU
        </div>
        <div className="flex-1">
          ...
          <div className="mt-4 flex flex-wrap gap-3 text-sm">
            ...
            <a
              ...
              className="font-medium text-text/70 hover:text-gold-deep"
            >
              Hire on Upwork
            </a>
          </div>
